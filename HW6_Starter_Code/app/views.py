...
def create_customer():
	...
	if form.validate_on_submit():
		...
		customer_id = add_customer(first_name, last_name, company, email, phone)
		add_address(street_address, city, state, country, zip_code, customer_id)
...
def create_order(value):
	...
	if orderForm.validate_on_submit():
		...
		add_order(name_of_part, manufacturer_of_part, customer_id)
		return redirect('/customers')
